...
parser.add_argument("-f", "--flie", help="data file path", default="./phone.dat")
...
if __name__ == "__main__":
    phone = Phone()
    info = phone._lookup_phone(args.phone_num)
    print(phone.human_phone_info(info))
